        ...
        <!-- Awal Navbar -->
            ...
            <div class="row no-gutters mt-5">
                ...
                <div class="col-md-10 p-5 pt-2">
                    ...
                    <!-- Awal tombol -->
                        <div class="tombol">
                        <a href="form_mobil.php"><button type="submit" class="btn btn-primary ml-5 mt-1">Form Mobil</button></a><i class="fas fa-arrow-right ml-2"></i>
                        <a href="form_pembeli.php"><button type="submit" class="btn btn-primary ml-2 mt-1">Form Pembeli</button></a>
                        </div>
                    <!-- Akhir tombol -->
